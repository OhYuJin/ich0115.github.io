		...
		success: function(xml){
			...
			if(listLength){
				...
				$(box).each(function(){
					...
					"</td><td class=movName>" + $(this).find("movieNm").text() +
					"</td><td class=movOpen>" + $(this).find("openDt").text() + 
					"</td><td class=movDcnt>" + $(this).find("audiCnt").text() + 
					"명</td><td class=movCcnt>" + $(this).find("audiAcc").text() + "명</td></tr>";
				});
